...
extern void ssd1306_draw_char_with_size(uint8_t *ssd, int16_t x, int16_t y, uint8_t character, float size);
extern void ssd1306_draw_string_with_size(uint8_t *ssd, int16_t x, int16_t y, char *string, float size);
